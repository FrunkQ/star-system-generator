...
Built with <a href="https://kit.svelte.dev/" target="_blank" rel="noopener noreferrer">SvelteKit</a>. Uses <a href="https://threejs.org/" target="_blank" rel="noopener noreferrer">three.js</a> (all 3D rendering and model loading), <a href="https://github.com/zeux/meshoptimizer" target="_blank" rel="noopener noreferrer">meshoptimizer</a> (simplifying high-poly ship models at import), <a href="https://github.com/101arrowz/fflate" target="_blank" rel="noopener noreferrer">fflate</a> (unzipping Universe Sandbox &amp; SpaceEngine imports), <a href="https://peerjs.com/" target="_blank" rel="noopener noreferrer">PeerJS</a> (live sharing to players' devices) and <a href="https://github.com/soldair/node-qrcode" target="_blank" rel="noopener noreferrer">qrcode</a> (share-link QR codes) — each under the MIT license. Ship-model decompression uses Google's <a href="https://github.com/google/draco" target="_blank" rel="noopener noreferrer">Draco</a> decoder (Apache-2.0), bundled from three.js's own distribution.</p>
